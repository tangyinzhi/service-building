...
require.config({
    ...
    shim: {
        ...
        bootstrap: {
            deps: ['jquery', 'rcss!/css/bootstrap.min.css']
        },
        openlayers: {
            deps: ['polyfill', 'proj4', "rcss!/css/ol.css"]
        },
        leaflet: {
            deps: ['rcss!/css/leaflet.css']
        },
        leafletdraw: {
            deps: ['leaflet', 'rcss!/css/leaflet.draw.css']
        },
        bsselect: {
            deps: ['jquery', 'bootstrap', 'rcss!/css/bootstrap-select.min']
        },
        bstreeview: {
            deps: ['bootstrap', 'rcss!/css/bootstrap-treeview.min']
        },
        vueautocomplete: {
            deps: ['vue', 'rcss!/css/vue2-autocomplete.css']
        },
        jstree: {
            deps: ['jquery', 'rcss!/css/jstree/default-dark/style.min.css']
        },
        cesium: {
            deps: ['rcss!/js/Cesium/Widgets/widgets.css']
        },
        plupload: {
            deps: ['js/moxie.min']
        },
        jqueryui: {
            deps: ['jquery', 'rcss!/css/jquery-ui.min.css']
        },
        pluploadui: {
            deps: ['jqueryui', 'plupload', 'rcss!/css/jquery.ui.plupload.css']
        },
        pluploadcn: {
            deps: ['pluploadui']
        },
        ...
        jqtree: {
            deps: ['jquery', 'rcss!/css/jqtree.css']
        },
        calendar: {
            deps: ['bootstrap', 'rcss!/css/calendar.css', '/js/underscore-min']
        },
        calendarcn: {
            deps: ['calendar']
        },
        bootstrapslider:{
            deps:['jquery',"rcss!/css/bootstrap-slider.min.css"]
        },
        bootstrapselect:{
            deps:['jquery','rcss!/css/bootstrap-select.min.css']
        },
        ...
        zTree: {
            deps: ['jquery', 'rcss!/Plugins/ztree/css/zTreeStyle/zTreeStyle.css']
        },
        range: {
            deps: ['jquery', 'rcss!/Plugins/range/range.css']
        },
        layer: {
            deps: ['jquery', 'rcss!/Plugins/layer/theme/default/layer.css']
        },
        jrange: {
            deps: ['jquery', 'rcss!/Plugins/jrange/jquery.range.css']
        },
        magnify: {
            deps: ['jquery', 'rcss!/Plugins/magnify/jquery.magnify.css']
        },
        sliderUi: {
            deps: ['jquery', 'rcss!/Plugins/jquery-ui/style.css']
        },
