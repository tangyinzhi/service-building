...
(function (ns) {
    ...
    window.SeHistorySliderMgr = SeHistorySliderMgr;
    //使用夸张系数拉杆条
        ...
        showSliderDom: function (options) {
            ...
            if (visible) {
                if (slider == null) {
                    ...
                    slider = data['slider'] = earth.GUIManager.CreateTerrainScaleSlider(520 + 80, y);
                    slider.Title = t;
        ...
        showSlider: function (options) {
            ...
            if (visible) {
                if (slider == null) {
                    ...
                    var t = _valueOrDefault(options, 'title', '');
                    //slider = data['slider'] = earth.GUIManager.CreateHistorySlider(520, y);
                    //邓杰
                    slider = data['slider'] = earth.GUIManager.CreateHistorySlider(100, 20);
                    slider.Title = t;
                    earth.Event.OnGUISliderClosed = function (id) {
                        if (bSync && isCloseSlider) { //1696联动状态下要关闭所有的拉杆条
