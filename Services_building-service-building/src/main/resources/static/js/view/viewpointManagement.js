...
window.onload = function () {
    ...
    $("#close_iframe").click(function () {
        parent.ViewPointManagementBtn = false;
        parent.setTableView(false, 135);
        parent.resizeEarthTool();
        parent.Tools.toolBarItemClickStyle("ViewPointManagement");
    });
    //上一页
...
var getWebView = function () {
    var path = parent.params.ip + "/viewImages/";
    return path;
}
/**
 * 添加缩略图
...
var getViewImageDir = function () {
    var dir = parent.params.ip.replace(/^http:\/{2}/g, '\\\\');
