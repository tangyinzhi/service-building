var CHANGED = false,
    ...
    DEFFLD = {
        ...
        item_checkbox: '<li><input name="CHKED" value="1" class="checkbox" type="checkbox" title="默认选中此项" /><input name="VAL" type="text" class="xs"/><a class="icononly-add iconfont icon-pos" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont icon-pos" title="删除此选择项">&#xe619;</a></li>',
        ...
        item_radio: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><input name="VAL" type="text" class="xs"/><a class="icononly-add iconfont icon-pos" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont icon-pos" title="删除此选择项">&#xe619;</a></li>',
        item_dropdown: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><input name="VAL" type="text" class="sl"/><a class="icononly-add iconfont" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont" title="删除此选择项">&#xe619;</a></li>',
        item_dropdown2: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><input name="VAL" type="text" class="sl"/><a class="icononly-add iconfont" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont" title="删除此选择项">&#xe619;</a></li>',
        ...
        item_likert_row: '<li><input name="LBL" class="xl" value="1" type="text"/><a class="icononly-add iconfont" title="添加新行">&#xe60b;</a><a class="icononly-del iconfont" title="删除此行">&#xe619;</a></li>',
        item_likert_col: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此列" /><input name="VAL" type="text" class="l"/><a class="icononly-add iconfont" title="添加新列">&#xe60b;</a><a class="icononly-del iconfont" title="删除此列">&#xe619;</a></li>',
        ...
        text: {
            ...
            json: '({LBL:"单行文本",TYP:"text",CLMV:"",FLDSZ:"m",REQD:"0",UNIQ:"0",SCU:"pub"})',
        ...
        number: {
            ...
            json: '({LBL:"数字框",TYP:"number",CLMV:"",FLDSZ:"s",REQD:"0",UNIQ:"0",SCU:"pub"})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        textarea: {
            ...
            json: '({LBL:"多行文本",TYP:"textarea",CLMV:"",FLDSZ:"s",REQD:"0",UNIQ:"0",SCU:"pub",MIN:"",MAX:"",DEF:"",INSTR:"",CSS:""})',
        ...
        checkbox: {
            ...
            json: '({LBL:"多选框",TYP:"checkbox",CLMV:"",LAY:"one",REQD:"0",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
            holder: '<li class="field prefocus" style="height:106px;width:97%"></li>'
        },
        radio: {
            html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"></div>',
            json: '({LBL:"单选框",TYP:"radio",CLMV:"",LAY:"one",REQD:"0",OTHER:"0",RDM:"0",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
            holder: '<li class="field prefocus" style="height:106px;width:97%"></li>'
        },
        dropdown: {
            html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"><select disabled="disabled" class="m input"></select></div>',
            json: '({LBL:"下拉框",TYP:"dropdown",CLMV:"",FLDSZ:"m",REQD:"0",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"0"},{VAL:"选项 2",CHKED:"0"},{VAL:"选项 3",CHKED:"0"}]})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        dropdown2: {
            ...
            json: '({LBL:"多级下拉框",TYP:"dropdown2",CLMV:"",FLDSZ:"m",pN:"2",REQD:"0",SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{DD1:{},DD2:{}},ITMS:[{VAL:"选项 1",CHKED:"0",ITMS:[{VAL:"选项 11"},{VAL:"选项 12"}]},{VAL:"选项 2",CHKED:"0",ITMS:[{VAL:"选项 21"},{VAL:"选项 22"}]}]})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        image: {
            html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"><input type="button" class="layui-btn layui-btn-sm layui-btn-normal  info_upload  " >上传图片</input><div class="layui-upload"><div class="layui-upload-list info_all"  style=";margin-left: 20px"></div></div></div>',
            json: '({LBL:"图片",TYP:"image",CLMV:"",IMG:"",REQD:"0",SCU:"pub",INSTR:"",CSS:""})',
        ...
        section: {
            ...
            json: '({LBL:"分隔符",TYP:"section",CLMV:"",SCU:"pub",SECDESC:"这里是分隔符说明",CSS:""})',
        ...
        html: {
            ...
            json: '({LBL:"HTML标题",TYP:"html",CLMV:"",SCU:"pub",HTML:"<p>这里可以显示HTML内容</p>",CSS:""})',
        ...
        date: {
            ...
            json: '({LBL:"日期",TYP:"date",CLMV:"",REQD:"0",UNIQ:"0",SCU:"pub",FMT:"ymd",DEF:"",INSTR:"",CSS:""})',
        ...
        time: {
            ...
            json: '({LBL:"时间",TYP:"time",CLMV:"",REQD:"0",UNIQ:"0",SCU:"pub",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        file: {
            ...
            json: '({LBL:"上传文件",TYP:"file",CLMV:"",FLDSZ:"m",REQD:"0",UNIQ:"0",SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{ID:{},TYP:{},SZ:{},NM:{}}})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        phone: {
            ...
            json: '({LBL:"手机",TYP:"phone",CLMV:"",REQD:"0",UNIQ:"0",SCU:"pub",FMT:"mobile",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        ...
        url: {
            ...
            json: '({LBL:"网址",TYP:"url",CLMV:"",FLDSZ:"xxl",REQD:"0",UNIQ:"0",SCU:"pub",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        money: {
            ...
            json: '({LBL:"价格",TYP:"money",CLMV:"",REQD:"0",UNIQ:"0",SCU:"pub",FMT:"yen",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        email: {
            ...
            json: '({LBL:"Email",TYP:"email",CLMV:"",FLDSZ:"m",REQD:"0",UNIQ:"0",SCU:"pub",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        name: {
            ...
            json: '({LBL:"姓名",TYP:"name",CLMV:"",REQD:"0",UNIQ:"0",SCU:"pub",FMT:"short",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        ...
        map: {
            html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"><div class="map"><img src="http://rs.jsform.com/rs/images/map.jpg"></div></div>',
            json: '({LBL:"地理位置",TYP:"map",CLMV:"",REQD:"0",SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{TXT:{},J:{},W:{}}})',
        ...
        address: {
            ...
            html: '<label class="desc"><span class="req hide"> *</span></label><div class="content textcontent"><input type="text" disabled="disabled" maxlength="255" class="input" /><i class="iconfont qrinput hide">&#xe67d;</i></div>',
            json: '({LBL:"地址",TYP:"address",CLMV:"",REQD:"0",SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{ZIP:{},PRV:{},CITY:{},DTL:{}}})',
            holder: '<li class="field prefocus" style="height:141px;width:97%"></li>'
        },
        address_en: '<textarea style="height:60px;" disabled="disabled" class="input xxl detail" placeholder="Street"></textarea></span>',
        address_cn: '<textarea style="height:60px;" disabled="disabled" class="input xxl detail" placeholder="详细地址"></textarea></span>',
        likert: {
            ...
            json: '({LBL:"组合单选框",TYP:"likert",CLMV:"",REQD:"0",HDNM:"0",SCU:"pub",CSS:"",ITMS:[{LBL:"行标签 1",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]},         {LBL:"行标签 2",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]},         {LBL:"行标签 3",ITMS:[{VAL:"列标签 1",CHKED:"0"},{VAL:"列标签 2",CHKED:"0"},{VAL:"列标签 3",CHKED:"0"},{VAL:"列标签 4",CHKED:"0"}]}]})',
...
layui.use(['element', 'table', 'form', 'jquery', 'laydate'], function () {
    ...
    function saveForm(e, f, c) {
        ...
        $.postJSON(SAVEFORM,
            ...
            function (g) {
                ...
                if (g.msg == '成功') {
                    setTimeout(function () {
                        sessionStorage.setItem('firstF', JSON.stringify(F));
                        layer.msg('表单保存成功', {icon: 1, time: 500});
                        return
                    }, 600)
                }
                $.extend(true, M, g.M);
                        ...
                        if (q.TYP === 'address') {
                            ...
                            if (q.TYP === 'radio') {
                                ...
                                if (q.TYP === 'checkbox') {
                                    ...
                                    if (q.TYP === 'image') {
                                        m.find('img').attr('src', q.IMG ? IMAGESURL + q.IMG : '../images/form/picUp.png')
                                    } else {
                                        if (q.TYP === 'goods') {
                ...
                if (res != null) {
                    if (res.code == 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            $("#clmvalue").append('<option value=' + data[i].Original + '>' + data[i].Original
                                + '</option>');
                        }
                    }
                }
    ...
    head.ready(function () {
        ...
        // }, 0.1 * 60 * 1000);
        // $('#saveForm').click(function () {
        //         $.post('http://192.168.30.15:8080/building/building/saveView', {'view':JSON.stringify(F)
        //         },function(res){//反显添加数据
        //             console.log(res)
        //         },"json");
        // })

        // $(document).on('click', '#saveForm', function (data) {
        //     $.post('http://192.168.30.15:8080/building/building/saveView', {'view':JSON.stringify(F)
        //     },function(res){//反显添加数据
        //         console.log(res)
        //     },"json");
        ...
        $('#preview').click(function () {
            ...
            sessionStorage.setItem("newF", JSON.stringify(F));
            sessionStorage.setItem("newM", JSON.stringify(M));
